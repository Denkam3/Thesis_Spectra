...
file_paths = ["JungleJuice500mW.csv"]
offsets = [0]  # Posuny pre jednotlivé dataset-y
file_paths_cal = ["pvTz_Mol1_Ram", "pvTz_Mol2_Ram", "pvTz_Mol3_Ram", "pvTz_Mol4_Ram", "pvTz_Mol5_Ram"]
offsets_cal = [10, 20, 30, 40, 50]  # Posuny pre jednotlivé dataset-y
data_list = []
...
# Nastavenie popisov
ax.set_xlabel(r'Ramanov posun ($\text{cm}^{-1}$)', fontsize=20, labelpad = 10)
ax.set_ylabel("Relatívna intenzita", fontsize=20, labelpad = 5)
