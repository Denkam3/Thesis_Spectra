...
def filter_data(data, threshold=250):
...
file_paths = ["pvTz_Mol1", "pvTz_Mol2", "pvTz_Mol3", "pvTz_Mol4", "pvTz_Mol5"]
offsets = [0, 100, 200, 300, 400]  # Posuny pre jednotlivé dataset-y
data_list = []
...
# Nastavenie popisov
ax.set_xlabel(r'Vlnočet ($\text{cm}^{-1}$)', fontsize=20)
ax.set_ylabel("Absorbancia", fontsize=20)
