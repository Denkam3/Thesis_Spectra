...
offsets = [0, 0.1, 0.2]  # Posuny pre jednotlivé dataset-y
data_list = []
...
bax = brokenaxes(xlims=((200, 1750), (2550, 3200)), hspace=0.05)  # Nastavenie prerušenia osi x
...
bax.axs[0].set_ylim(-0.04, 0.4)
bax.axs[1].set_ylim(-0.04, 1)
